			...
			<div class="row">
				<div class="col-md-4">
					<div class="card mb-4 shadow-sm">
						...
						<h2 class="text-center"><?= $nasional['Confirmed']; ?></h2>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card mb-4 shadow-sm">
						...
						<h2 class="text-center"><?= $nasional['Recovered']; ?></h2>
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card mb-4 shadow-sm">
						...
						<h2 class="text-center"><?= $nasional['Deaths']; ?></h2>
						<div class="card-body">
	...
	<div id="protokol" class="container protokol">
		...
		<div class="row">
			<div class="col-md-15">
				...
				<li>Berikut adalah link website penyedia API Covid-19 di Indonesia : <a href="https://corona.coollabs.work/" target="_blank"><i class="fab fa-js-square"></i> </i>ID | Collabs Work.</a></li>
				<li>Dibuat menggunakan framework PHP dan CSS, yaitu Codeigniter (v3.1.3) dan Bootstrap (v4.5.0).</li>
